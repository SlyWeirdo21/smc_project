...
// 4.
// ---------------------------- if 형식
// let fixedCost = Number(prompt("1.고정 비용"));
// let productionCost = Number(prompt("2.생산 비용"));
// let salesCost = Number(prompt("3.판매 비용"));

// console.log(Math.floor(fixedCost / (salesCost - productionCost) + 1))
...
// while(true) {
//     if(fixedCost + productionCost * manufacturecount < salesCost * manufacturecount) {
//         break;
//     }
//     manufacturecount++;
// }
// console.log(manufacturecount);
