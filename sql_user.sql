...
CREATE TABLE PAYMENT_HISTORY (
    id number NOT NULL,
    oroder_date date NOT NULL,
    order_status varchar2(16) NOT NULL,  -- PAYMENT_WAITING, PAYMENT_SUCCESS, SHIPPING, SHIPPPED
    ...
    CONSTRAINT PAYMENT_HISTORY_CK CHECK (order_status IN('PAYMENT_WAITING','PAYMENT_SUCCESS','SHIPPING','SHIPPPED'))
);

COMMENT ON COLUMN PAYMENT_HISTORY.ORDER_STATUS IS '주문 진행 잔계, 4가지 단계만 들어갈 수 있도록 함';
